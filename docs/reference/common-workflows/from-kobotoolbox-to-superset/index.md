...
Windmill will be used to fetch the data from Kobotoolbox, and store the data in your data warehouse.
   ...
   You will need to share the following information with your **Windmill [Admin](/reference/gc-toolkit/gc-scripts-hub/user-roles/#administrator)**:
...
If you are a **Windmill [Admin](/reference/gc-toolkit/gc-scripts-hub/user-roles/#administrator)**, you will use this data to to set up the account in Windmill.
