...
* **New reference pages**: Created new technical documentation covering [landing page personalization](/reference/gc-toolkit/gc-landing-page), an expanded Superset [cookbook with advanced SQL queries]([url](/reference/gc-toolkit/superset/queries)) (e.g., converting text strings to timestamp fields), [Mapbox style customization procedures](/reference/gc-toolkit/externally-hosted/mapbox/customization), and [supplemental tool profiles](/reference/gc-toolkit/other-tools) for the new HTTP Server and Wildlife Viewer.
