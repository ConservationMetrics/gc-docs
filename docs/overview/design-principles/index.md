...
In alignment with the [CARE Principles for Indigenous Data Governance](/tutorials/guide-data-sovereignty-and-protocols/#what-are-the-care-principles-for-indigenous-data-governance), our partners must be able to:
