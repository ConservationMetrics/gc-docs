...
:::info
The following pillars are the foundation of data sovereignty in Guardian Connector. Currently, we are in the process of implementing these pillars, and several of these are still _aspirational_ at this time.
:::
...
* **Own the infrastructure & hosting decisions** — community organizations choose servers (local, regional, or cloud) and retain control.  
...
* **Durable digital good** — platform designed to remain functional and relevant beyond funding cycles and as data projects and tools come and go.  
