...
Guardian Connector is built as an open-source ecosystem of interconnected tools designed to support Indigenous data sovereignty and community-based environmental monitoring. 

For developers interested in contributing, deploying, or extending Guardian Connector, these repositories provide the core building blocks and deployment infrastructure.

## 📦 Core Repositories (Github)
...
- **[Guardian Connector Landing Page](https://github.com/ConservationMetrics/gc-landing-page)** - The Guardian Connector landing page
