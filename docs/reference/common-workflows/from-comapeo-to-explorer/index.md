...
If you are the **Windmill [Admin](/reference/gc-toolkit/gc-scripts-hub/user-roles/#administrator)** within your Guardian Connector instance, there's an extra step that you need to do **one time per Guardian Connector instance**.
